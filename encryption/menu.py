...
from frequency_analysis.truecasing import true_casing_by_stats
        ...
        while 1:
            ...
            if key == curses.KEY_UP and current_row > 0:
                ...
                if current_row == len(self.menu) - 1:
                    ...
                    self.stdscr.clear()
                    if os.path.exists('./data/encoded_text.txt'):
                        with open('./data/encoded_text.txt') as file:
                    ...
                    message = true_casing_by_stats(message)
                    with open('./data/decoded_text.txt', 'w') as file:
                        file.write(message)
                    ...
                    self.color_print(2, 4, "You can type the message below or click right mouse button to paste "
                                           "clipboard text", 3)
                    ...
                    with open('./data/encoded_text.txt', 'w') as file:
